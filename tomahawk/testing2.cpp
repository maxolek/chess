...
int main() {
   ...
   //return 0;
    ...
    //print_bitboard(PrecomputedMoveData::alignMasks[b5][a3]);
    //print_bitboard(PrecomputedMoveData::alignMasks[b5][a4]);
    
    //test.completePerftTest();
    //return 0;
    test.perftDivide(1, "r4rk1/1pp1qppp/p1np1n2/8/2P5/2N1PN2/PP2QPPP/2KR1B1R w - -");
    std::cout << test.perft(2,"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
    return 0;
    ...
    // ************************
    test.runPerft(2, true, "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - "); // quits on depth 5+, depth 4 starting pos is short on moves
